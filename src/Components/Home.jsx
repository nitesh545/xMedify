...
export default function Home() {
	return (
		<Box sx={{width: '100vw', height: '100vh', display: 'flex', backgroundColor: 'rgba(231, 240, 255, 1)', padding: '10rem'}}>
			<Box sx={{width: '50vw', mt: '14rem'}}>
				...
				<Typography variant='h4' color='rgba(92, 97, 105, 1)' sx={{width: '35vw', lineHeight: '4rem'}}>Connect instantly with a 24x7 specialist or choose
					to video visit a particular doctor.</Typography>
				<Button variant='contained' sx={{backgroundColor: 'rgba(42, 168, 255, 1)', mt: '2rem', py: '1rem', px: '2rem', borderRadius: '0.5rem'}}>Find Centers</Button>
			</Box>
